...
Namespace XtraPivotGrid_ChartsIntegration
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddSalesPersonRow(ByVal Sales_Person As String, ByVal Quantity As Short, ByVal OrderDate As System.DateTime) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { Sales_Person, Quantity, OrderDate}
	...
	End Class
End Namespace
Namespace XtraPivotGrid_ChartsIntegration.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        [Sales Person], Quantity, OrderDate" & Constants.vbCrLf & "FROM            SalesPerson"
